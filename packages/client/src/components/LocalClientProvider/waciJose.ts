import type {JWTVerifyGetKey, JWTVerifyOptions} from 'jose/jwt/verify'
import type {JWTVerifyResult, SignOptions, JWTPayload, KeyLike} from 'jose/types'

import {OfferChallengeJWTPayload, OfferResponseJWTPayload, RequestChallengeJWTPayload, RequestResponseJWTPayload} from '@waci-demo/waci-core'

const {SignJWT} = require('jose/dist/browser/jwt/sign')
const {jwtVerify} = require('jose/dist/browser/jwt/verify')
const {JWTClaimValidationFailed, JWTInvalid} = require('jose/dist/browser/util/errors')
